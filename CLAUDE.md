...
The canvas itself is tiny (208x144, drawn at `TILE=16`px) and scaled up 4x via CSS in `index.html` for a pixel-art look — `ctx.imageSmoothingEnabled = false` is required to keep edges crisp.
